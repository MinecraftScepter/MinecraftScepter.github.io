          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 3;
                return currentState.copyWith({
                  isPriceValid: currentState.currency.toLocaleLowerCase() === "usd" ? event.price >= 1 : event.price >= 30,
                  price: event.price
                });
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 5:
                ...
                if (previousCurrency.toLocaleLowerCase() == "usd" && targetCurrency.toLocaleLowerCase() == "twd") {
                  price = price * 30;
                }

                if (previousCurrency.toLocaleLowerCase() == "twd" && targetCurrency.toLocaleLowerCase() == "usd") {
                  price = price / 30;
                }
                ...
                return currentState.copyWith({
                  ...
                  price: price,
                  isPriceValid: targetCurrency.toLocaleLowerCase() === "usd" ? price >= 1 : price >= 30
                });
...
//# sourceMappingURL=donation.js.64f9acda3e616e5cac13.hot-update.js.map