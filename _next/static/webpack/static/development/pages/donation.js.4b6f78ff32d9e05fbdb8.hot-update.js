...
/* harmony import */ var _felangel_react_bloc__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @felangel/react-bloc */ "./node_modules/@felangel/react-bloc/dist/react-bloc.es5.js");
/* harmony import */ var _bloc_donation_bloc__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./_bloc/_donation_bloc */ "./pages/donation/_bloc/_donation_bloc.ts");
/* harmony import */ var _src_components_withTextEnchancer__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../src/components/withTextEnchancer */ "./src/components/withTextEnchancer.tsx");
/* harmony import */ var _src_utility_bloc_utility__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../src/utility/bloc_utility */ "./src/utility/bloc_utility.ts");
/* harmony import */ var _src_components_paypal_button__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../src/components/paypal_button */ "./src/components/paypal_button.tsx");
/* harmony import */ var _src_config__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../src/config */ "./src/config/index.ts");
...
function Index() {
  ...
  var bloc = Object(_src_utility_bloc_utility__WEBPACK_IMPORTED_MODULE_21__["useBloc"])(new _bloc_donation_bloc__WEBPACK_IMPORTED_MODULE_19__["DonationBloc"]());
  return __jsx(_material_ui_core_Container__WEBPACK_IMPORTED_MODULE_13__["default"], {
  ...
  }, __jsx(_material_ui_icons_LockOutlined__WEBPACK_IMPORTED_MODULE_17___default.a, null)), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_10__["default"], {
    component: "h1",
    variant: "h5"
  }, "\u8D0A\u52A9\u57FA\u672C\u8CC7\u6599"), __jsx(_felangel_react_bloc__WEBPACK_IMPORTED_MODULE_18__["BlocBuilder"], {
    bloc: bloc,
    builder: function builder(state) {
      return __jsx("form", {
        ...
        item: true,
        xs: 12
      }, __jsx(_src_components_withTextEnchancer__WEBPACK_IMPORTED_MODULE_20__["TextFieldEx"], {
        label: "Email",
        variant: "outlined",
        id: "email",
        name: "email",
        ...
        observedChanged: function observedChanged(value) {
          bloc.dispatch(new _bloc_donation_bloc__WEBPACK_IMPORTED_MODULE_19__["ModifyEmailEvent"](value));
        },
        fullWidth: true,
        autoComplete: "email",
        required: true,
        ...
        observedChanged: function observedChanged(value) {
          bloc.dispatch(new _bloc_donation_bloc__WEBPACK_IMPORTED_MODULE_19__["ModifyNameEvent"](value));
        }
      })), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_9__["default"], {
        item: true,
        xs: 12
        ...
        helperText: !state.isPriceValid ? "最低 30 台幣！" : "",
        observedChanged: function observedChanged(value) {
          bloc.dispatch(new _bloc_donation_bloc__WEBPACK_IMPORTED_MODULE_19__["ModifyPriceEvent"](_babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_3___default()(value)));
        }
      }), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_16__["FormControl"], {
        required: true
      }, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_16__["Select"], {
        value: "TWD",
        onChange: function onChange(v) {}
      }, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_16__["MenuItem"], {
        value: ""
      }, __jsx("em", null, "None")), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_16__["MenuItem"], {
        value: 10
      }, "Ten"), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_16__["MenuItem"], {
        value: 20
      }, "Twenty"), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_16__["MenuItem"], {
        value: 30
      }, "Thirty")))), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_9__["default"], {
        item: true,
        xs: 12
      }, __jsx(_src_components_withTextEnchancer__WEBPACK_IMPORTED_MODULE_20__["TextFieldEx"], {
        label: "\u60F3\u8981\u7684\u529F\u80FD\u6216\u6539\u5584(\u9078\u586B)",
        ...
        observedChanged: function observedChanged(value) {
          bloc.dispatch(new _bloc_donation_bloc__WEBPACK_IMPORTED_MODULE_19__["ModifyTitleEvent"](value));
        }
      })), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_9__["default"], {
        item: true,
        xs: 12
        ...
        observedChanged: function observedChanged(value) {
          bloc.dispatch(new _bloc_donation_bloc__WEBPACK_IMPORTED_MODULE_19__["ModifyCommentEvent"](value));
        }
      })), __jsx(_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_9__["default"], {
        item: true,
        xs: 12
        ...
        onClick: function onClick(e) {
          e.preventDefault();
          bloc.dispatch(new _bloc_donation_bloc__WEBPACK_IMPORTED_MODULE_19__["SubmitEvent"](window));
        }
      }, "\u8D0A\u52A9"), __jsx("div", {
        style: {
      ...
      }, __jsx(_src_components_paypal_button__WEBPACK_IMPORTED_MODULE_22__["PayPalButton"], {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    console.log("CALLA");
                    _context.next = 4;
                    return superagent__WEBPACK_IMPORTED_MODULE_15___default.a.agent().post(_src_config__WEBPACK_IMPORTED_MODULE_23__["default"].helperApi + "/tests/paypal_callback").send(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()({
        ...
        options: {
          clientId: _src_config__WEBPACK_IMPORTED_MODULE_23__["default"].paypalClientId
        }
      })));
    }
...
//# sourceMappingURL=donation.js.4b6f78ff32d9e05fbdb8.hot-update.js.map