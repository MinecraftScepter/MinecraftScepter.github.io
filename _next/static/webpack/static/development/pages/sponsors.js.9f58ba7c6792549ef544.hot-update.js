...
function Index() {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["CssBaseline"], null), __jsx(_src_header__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    variant: "h4"
  }, t.sponsor.donators)), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Box"], {
    height: 16
    ...
    item: true,
    sm: 6
  }, __jsx(DontaionTopSection, null)), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Grid"], {
    item: true,
    sm: 6
  }, __jsx(DontaionLatestSection, null))))), __jsx(_src_footer__WEBPACK_IMPORTED_MODULE_5__["default"], {
    style: undefined
  }));
}
...
function DontaionTopSection() {
  ...
  return __jsx(_felangel_react_bloc__WEBPACK_IMPORTED_MODULE_9__["BlocBuilder"], {
    ...
    builder: function builder(state) {
      ...
      return __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Card"], {
      ...
      }, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Typography"], null, "\uD83C\uDFC6", t.sponsor.top_donation), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Divider"], null), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Box"], {
        height: 16
      ...
      }, t.sponsor.donator), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TableCell"], {
        style: {
          fontWeight: "bold",
          color: "rgb(255,244,119)"
        },
        align: "right"
      }, t.sponsor.moeny))), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TableBody"], {
        style: {
          color: "rgb(97,63,0)"
        }
        ...
        }, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TableCell"], null, state.page == 0 ? index == 0 ? "\uD83D\uDC51".concat(data.names[data.names.length - 1]) : index == 1 ? "\u2B50\uFE0F".concat(data.names[data.names.length - 1]) : index == 2 ? "\uD83D\uDE80".concat(data.names[data.names.length - 1]) : "".concat(data.names[data.names.length - 1]) : "".concat(data.names[data.names.length - 1])), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TableCell"], {
          align: "right"
        }, "TWD ", data.total));
      }))), __jsx("div", {
        style: {
      ...
      }, __jsx("span", null, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["IconButton"], {
        disabled: !state.isPrevValid,
        onClick: function onClick(_) {
          return bloc.dispatch(new _bloc_donation_section_bloc__WEBPACK_IMPORTED_MODULE_7__["PreviousPageEvent"]());
        }
      }, __jsx(_material_ui_icons__WEBPACK_IMPORTED_MODULE_2__["ArrowLeft"], null)), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["IconButton"], {
        disabled: !state.isNextValid,
        onClick: function onClick(_) {
          return bloc.dispatch(new _bloc_donation_section_bloc__WEBPACK_IMPORTED_MODULE_7__["NextPageEvent"]());
        }
      }, __jsx(_material_ui_icons__WEBPACK_IMPORTED_MODULE_2__["ArrowRight"], null))))));
    }
  });
}
...
function DontaionLatestSection() {
  ...
  var t = Object(_src_utility_translator_translatorContext__WEBPACK_IMPORTED_MODULE_6__["useTranslatorContext"])();
  react__WEBPACK_IMPORTED_MODULE_0___default.a.useEffect(function () {
    bloc.dispatch(new _bloc_donation_section_bloc__WEBPACK_IMPORTED_MODULE_7__["PageStartEvent"](_bloc_donation_section_bloc__WEBPACK_IMPORTED_MODULE_7__["DonationType"].Latest));
  });
  return __jsx(_felangel_react_bloc__WEBPACK_IMPORTED_MODULE_9__["BlocBuilder"], {
    bloc: bloc,
    builder: function builder(state) {
      ...
      return __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Card"], {
      ...
      }, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Typography"], null, "\uD83C\uDD95", t.sponsor.new_donation), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Divider"], null), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Box"], {
        height: 16
      }), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TableContainer"], null, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["Table"], {
        style: {
          borderTopLeftRadius: 16,
        ...
        }, __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TableCell"], null, "".concat(data.name)), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_1__["TableCell"], {
          align: "right"
        }, "TWD ", data.price));
      }))), __jsx("div", {
        style: {
...
//# sourceMappingURL=sponsors.js.9f58ba7c6792549ef544.hot-update.js.map